...
<section class="container-fluid">
  ...
  <div class="row">
    <aside class="col-sm-3 col-md-2 col-lg-2 sidebar">
      ...
      <ul class="nav nav-sidebar">
        <li><a href="/LibraryWeb/backStage/goLeaguer" target="main">会员管理</a></li>
        <li><a href="#">文件管理</a></li>
        <li><a href="#">权限管理</a></li>
  ...
  <!-- <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main"> -->
    <iframe src="welcome.html" frameborder="0" scrolling="no" name="main" id="main" class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2" style=" padding: 0px; width: 100%"></iframe>
  <!-- </div> -->
</section>
<!--个人信息模态框-->
